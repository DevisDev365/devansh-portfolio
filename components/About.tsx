...
const SKILL_BADGES: Record<string, string> = {
  ...
  "LLM APIs": "https://img.shields.io/badge/OpenAI-412991?style=for-the-badge&logo=openai&logoColor=white",
  "Data Analysis": "https://img.shields.io/badge/Pandas-150458?style=for-the-badge&logo=pandas&logoColor=white",
  "Business Strategy": "https://img.shields.io/badge/Strategy-Business-blue?style=for-the-badge",
  "Project Management": "https://img.shields.io/badge/Management-Project-orange?style=for-the-badge",
  "Automotive Ops": "https://img.shields.io/badge/Ops-Automotive-red?style=for-the-badge",
  "Sales Optimization": "https://img.shields.io/badge/Sales-Optimization-green?style=for-the-badge",
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
                {[
                    ...
                    <div key={i} className="bg-[#0F0F0F] border border-white/5 p-6 rounded-xl flex flex-col items-center text-center hover:border-primary/30 transition-colors group">
                        ...
                        <p className="text-[10px] text-slate-600 font-mono">{stat.desc}</p>
                    </div>
                ))}
            </div>
        </Reveal>
             ...
             <Reveal delay={400}>
              <div className="bg-[#0a0a0a]/80 backdrop-blur-md p-8 rounded-xl border border-white/10 hover:border-primary/50 transition-colors shadow-2xl">
                ...
                <div className="flex flex-wrap gap-2">
                  {Object.entries(SKILL_BADGES).map(([name, url]) => (
                    <img key={name} src={url} alt={name} className="h-6 md:h-7 rounded shadow-sm hover:scale-105 transition-transform" />
                  ))}
                </div>
