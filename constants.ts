...
export const TECHNICAL_SKILLS = [
  { name: "Python", url: "https://www.python.org/", badge: "https://img.shields.io/badge/Python-3776AB?style=for-the-badge&logo=python&logoColor=white" },
  { name: "SQL", url: "https://en.wikipedia.org/wiki/SQL", badge: "https://img.shields.io/badge/SQL-4479A1?style=for-the-badge&logo=mysql&logoColor=white" },
  { name: "Power BI", url: "https://powerbi.microsoft.com/", badge: "https://img.shields.io/badge/Power_BI-F2C811?style=for-the-badge&logo=powerbi&logoColor=black" },
  { name: "Excel VBA", url: "https://learn.microsoft.com/en-us/office/vba/api/overview/excel", badge: "https://img.shields.io/badge/Excel-217346?style=for-the-badge&logo=microsoft-excel&logoColor=white" },
  { name: "LLM APIs", url: "https://platform.openai.com/docs/introduction", badge: "https://img.shields.io/badge/OpenAI-412991?style=for-the-badge&logo=openai&logoColor=white" },
  { name: "Data Analysis", url: "https://en.wikipedia.org/wiki/Data_analysis", badge: "https://img.shields.io/badge/Pandas-150458?style=for-the-badge&logo=pandas&logoColor=white" },
  { name: "Business Strategy", url: "https://en.wikipedia.org/wiki/Strategic_management", badge: "https://img.shields.io/badge/Strategy-Business-blue?style=for-the-badge" },
  { name: "Project Management", url: "https://www.pmi.org/", badge: "https://img.shields.io/badge/Management-Project-orange?style=for-the-badge" },
  { name: "Automotive Ops", url: "https://en.wikipedia.org/wiki/Operations_management", badge: "https://img.shields.io/badge/Ops-Automotive-red?style=for-the-badge" },
  { name: "Sales Optimization", url: "https://en.wikipedia.org/wiki/Sales_operations", badge: "https://img.shields.io/badge/Sales-Optimization-green?style=for-the-badge" },
  { name: "JavaScript", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript", badge: "https://img.shields.io/badge/JavaScript-F7DF1E?style=for-the-badge&logo=javascript&logoColor=black" },
  { name: "XGBoost", url: "https://xgboost.readthedocs.io/", badge: "https://img.shields.io/badge/XGBoost-FF6600?style=for-the-badge&logo=xgboost&logoColor=white" },
  { name: "Supabase", url: "https://supabase.com/", badge: "https://img.shields.io/badge/Supabase-3ECF8E?style=for-the-badge&logo=supabase&logoColor=white" },
  { name: "Revenue Management", url: "https://en.wikipedia.org/wiki/Revenue_management", badge: "https://img.shields.io/badge/Revenue-Management-blue?style=for-the-badge" },
  { name: "Demand Forecasting", url: "https://en.wikipedia.org/wiki/Demand_forecasting", badge: "https://img.shields.io/badge/Demand-Forecasting-blueviolet?style=for-the-badge" },
  { name: "Business Process Automation", url: "https://en.wikipedia.org/wiki/Business_process_automation", badge: "https://img.shields.io/badge/BPA-Automation-orange?style=for-the-badge" },
  { name: "Manufacturing Analytics", url: "https://en.wikipedia.org/wiki/Manufacturing_operations_management", badge: "https://img.shields.io/badge/Manufacturing-Analytics-red?style=for-the-badge" },
  { name: "Strategic Account Management", url: "https://en.wikipedia.org/wiki/Key_account_management", badge: "https://img.shields.io/badge/SAM-Account_Mgmt-success?style=for-the-badge" }
];
